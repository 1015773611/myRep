/**
 * 百度地图的鼠标画圆工具。
 * 允许用户在地图上点击完成鼠标绘制圆形的功能。
 * 使用者可以自定义所绘制结果的相关样式，例如线宽、颜色、显示面积等等。
 * 基于Baidu Map API 1.4。
 *
 * @author ICE
 * @version 1.0
...
(function() {
    ...
    /** 
     * @exports CircleTool as BMapLib.CircleTool 
     */
    var CircleTool =
        /**
         * CircleTool类的构造函数
         ...
         * <br />"<b>enableCalculate</b>" : {Boolean} 绘制是否进行测面
		 ...
		 *	};
         * var myCircleToolObject = new BMapLib.CircleTool(map, {isOpen: true, 
    	 ...
    	 *  myCircleToolObject.addEventListener('overlaycomplete', function(e, circle){
		 *		myCircleToolObject.close();
		 *	});
         */
        BMapLib.CircleTool = function(map, opts){
            if (!map) {
                return;
            }
            instances.push(this);
    ...
    // 通过baidu.lang下的inherits方法，让CircleTool继承baidu.lang.Class
    baidu.lang.inherits(CircleTool, baidu.lang.Class, "CircleTool");

    /**
     * 开启地图的绘制模式
     *
     * @example <b>参考示例：</b><br />
     * myCircleToolObject.open();
     */
    CircleTool.prototype.open = function() {
        // 判断绘制状态是否已经开启
     ...
     * myCircleToolObject.close();
     */
    CircleTool.prototype.close = function() {
    ...
    /**
     * 设置当前的绘制模式，参数DrawingType，为4个可选常量:
     * <br/>BMAP_DRAWING_CIRCLE    画圆
     * @param {DrawingType} DrawingType
     * @return {Boolean} 
     *
     * @example <b>参考示例：</b><br />
     * myCircleToolObject.setDrawingMode(BMAP_DRAWING_CIRCLE);
     */
    CircleTool.prototype.setDrawingMode = function(drawingType) {
        //与当前模式不一样时候才进行重新绑定事件
     ...
     *
     * @example <b>参考示例：</b><br />
     * alert(myCircleToolObject.getDrawingMode());
     */
    CircleTool.prototype.getDrawingMode = function() {
     ...
     *
     * @example <b>参考示例：</b><br />
     * myCircleToolObject.enableCalculate();
     */
    CircleTool.prototype.enableCalculate = function() {
     ...
     *
     * @example <b>参考示例：</b><br />
     * myCircleToolObject.disableCalculate();
     */
    CircleTool.prototype.disableCalculate = function() {
        this._enableCalculate = false;
    }

    /**
     * 鼠标绘制完成后，派发总事件的接口
     * @name CircleTool#overlaycomplete
     * @event
     ...
     *
     * @example <b>参考示例：</b>
     * myCircleToolObject.addEventListener("overlaycomplete", function(e) {
     *     alert(e.drawingMode);
     *     alert(e.overlay);
     *     alert(e.calculate);
     *     alert(e.label);
    ...
    /**
     * 绘制圆完成后，派发的事件接口
     * @name CircleTool#circlecomplete
     * @event
     * @param {Circle} overlay 回调函数会返回相应的覆盖物，
     * <br />{"<b>overlay</b> : {Circle} 
     *
     * @example <b>参考示例：</b>
     * myCircleToolObject.addEventListener("circlecomplete", function(e, overlay) {
     *     alert(overlay);
     * });
     */
     ...
     * @param {Object} 参数
     */
    CircleTool.prototype._initialize = function(map, opts) {
         ...
         * @type {DrawingType}
         */
        this._drawingType = /*opts.drawingMode ||*/ BMAP_DRAWING_CIRCLE;
     ...
     */
    CircleTool.prototype._open = function() {
     ...
     * @param {DrawingType}
     */
    CircleTool.prototype._setDrawingMode = function(drawingType) {
     ...
     */
    CircleTool.prototype._close = function() {
     ...
     * 绑定鼠标画圆的事件
     */
    CircleTool.prototype._bindCircle = function() {
     ...
     * @param {point} 显示的位置
     */
    CircleTool.prototype._calculate = function (overlay, point) {
        var result = {
            data  : 0,    //计算出来的长度或面积
     ...
     */
    CircleTool.prototype._addGeoUtilsLibrary = function () {
        if (!BMapLib.GeoUtils) {
     ...
     */
    CircleTool.prototype._addLabel = function (point, content) {
     ...
     * 派发事件
     */
    CircleTool.prototype._dispatchOverlayComplete = function (overlay, calculate) {
        var options = {
            'overlay'     : overlay,
    ...
    //用来存储用户实例化出来的circleTool对象
    var instances = [];

    /*
     * 关闭其他实例的绘制模式
     * @param {CircleTool} 当前的实例
     */
